...
void ShapesApp::LoadTextures()
{
	...
	brickcleanTex->Filename = L"Textures/CastleWall.dds";
	ThrowIfFailed(DirectX::CreateDDSTextureFromFile12(md3dDevice.Get(),
		mCommandList.Get(), brickcleanTex->Filename.c_str(),
		brickcleanTex->Resource, brickcleanTex->UploadHeap));

	auto TowerWallTex = std::make_unique<Texture>();
	TowerWallTex->Name = "towerTex";
	TowerWallTex->Filename = L"Textures/TowerWall.dds";
	ThrowIfFailed(DirectX::CreateDDSTextureFromFile12(md3dDevice.Get(),
		mCommandList.Get(), TowerWallTex->Filename.c_str(),
		TowerWallTex->Resource, TowerWallTex->UploadHeap));

	auto Merlin2Tex = std::make_unique<Texture>();
	Merlin2Tex->Name = "MBrickTex";
	Merlin2Tex->Filename = L"Textures/Merlin.dds";
	ThrowIfFailed(DirectX::CreateDDSTextureFromFile12(md3dDevice.Get(),
		mCommandList.Get(), Merlin2Tex->Filename.c_str(),
		Merlin2Tex->Resource, Merlin2Tex->UploadHeap));

	auto GroundTex = std::make_unique<Texture>();
	GroundTex->Name = "groundTex";
	GroundTex->Filename = L"Textures/Ground2.dds";
	ThrowIfFailed(DirectX::CreateDDSTextureFromFile12(md3dDevice.Get(),
	...
	mTextures[TowerWallTex->Name] = std::move(TowerWallTex);
	mTextures[Merlin2Tex->Name] = std::move(Merlin2Tex);
...
void ShapesApp::BuildDescriptorHeaps()
{
	...
	auto brickcleanTex = mTextures["tileTex"]->Resource;
	auto TowerWallTex = mTextures["towerTex"]->Resource;
	auto Merlin2Tex = mTextures["MBrickTex"]->Resource;
	...
	srvDesc.Format = brickcleanTex->GetDesc().Format;
	srvDesc.Texture2D.MipLevels = brickcleanTex->GetDesc().MipLevels;
	md3dDevice->CreateShaderResourceView(brickcleanTex.Get(), &srvDesc, hDescriptor);

	// next descriptor
	hDescriptor.Offset(1, mCbvSrvDescriptorSize);

	srvDesc.Format = TowerWallTex->GetDesc().Format;
	srvDesc.Texture2D.MipLevels = TowerWallTex->GetDesc().MipLevels;
	md3dDevice->CreateShaderResourceView(TowerWallTex.Get(), &srvDesc, hDescriptor);

	// next descriptor
	hDescriptor.Offset(1, mCbvSrvDescriptorSize);

	srvDesc.Format = Merlin2Tex->GetDesc().Format;
	srvDesc.Texture2D.MipLevels = Merlin2Tex->GetDesc().MipLevels;
	md3dDevice->CreateShaderResourceView(Merlin2Tex.Get(), &srvDesc, hDescriptor);
...
void ShapesApp::BuildMaterials()
{
	...
	tile0->FresnelR0 = XMFLOAT3(0.05f, 0.05f, 0.05f);
	tile0->Roughness = 0.1f;

	auto tower0 = std::make_unique<Material>();
	tower0->Name = "tower0";
	tower0->MatCBIndex = 3;
	tower0->DiffuseSrvHeapIndex = 3;
	tower0->DiffuseAlbedo = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
	tower0->FresnelR0 = XMFLOAT3(0.05f, 0.05f, 0.05f);
	tower0->Roughness = 0.1f;

	auto mbrick0 = std::make_unique<Material>();
	mbrick0->Name = "mbrick0";
	mbrick0->MatCBIndex = 4;
	mbrick0->DiffuseSrvHeapIndex = 4;
	mbrick0->DiffuseAlbedo = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
	mbrick0->FresnelR0 = XMFLOAT3(0.05f, 0.05f, 0.05f);
	mbrick0->Roughness = 0.1f;

	auto ground0 = std::make_unique<Material>();
	ground0->Name = "ground0";
	ground0->MatCBIndex = 5;
	ground0->DiffuseSrvHeapIndex = 5;
	ground0->DiffuseAlbedo = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
	ground0->FresnelR0 = XMFLOAT3(0.05f, 0.05f, 0.05f);
	ground0->Roughness = 0.4f;

	mMaterials["bricks0"] = std::move(bricks0);
	mMaterials["stone0"] = std::move(stone0);
	mMaterials["tile0"] = std::move(tile0);
	mMaterials["tower0"] = std::move(tower0);
	mMaterials["mbrick0"] = std::move(mbrick0);
	mMaterials["ground0"] = std::move(ground0);
...
void ShapesApp::BuildRenderItems()
{
	...
	box2Ritem->Mat = mMaterials["tile0"].get();
	...
	box3Ritem->Mat = mMaterials["tile0"].get();
	...
	box4Ritem->Mat = mMaterials["tile0"].get();
	...
	box5Ritem->Mat = mMaterials["tile0"].get();
	...
	box6Ritem->Mat = mMaterials["tile0"].get();
	...
	FMerlin1->Mat = mMaterials["mbrick0"].get();
	...
	FMerlin2->Mat = mMaterials["mbrick0"].get();
	...
	FMerlin3->Mat = mMaterials["mbrick0"].get();
	...
	FMerlin4->Mat = mMaterials["mbrick0"].get();
	...
	FMerlin5->Mat = mMaterials["mbrick0"].get();
	...
	FMerlin6->Mat = mMaterials["mbrick0"].get();
	...
	FMerlin7->Mat = mMaterials["mbrick0"].get();
	...
	BMerlin1->Mat = mMaterials["mbrick0"].get();
	...
	BMerlin2->Mat = mMaterials["mbrick0"].get();
	...
	BMerlin3->Mat = mMaterials["mbrick0"].get();
	...
	BMerlin4->Mat = mMaterials["mbrick0"].get();
	...
	BMerlin5->Mat = mMaterials["mbrick0"].get();
	...
	BMerlin6->Mat = mMaterials["mbrick0"].get();
	...
	BMerlin7->Mat = mMaterials["mbrick0"].get();
	...
	gridRitem->Mat = mMaterials["ground0"].get();
	gridRitem->Geo = mGeometries["shapeGeo"].get();
	...
	for (int i = 0; i < 2; ++i)
	{
		...
		leftCylRitem->Mat = mMaterials["tower0"].get();
		leftCylRitem->Geo = mGeometries["shapeGeo"].get();
		...
		rightCylRitem->Mat = mMaterials["tower0"].get();
		rightCylRitem->Geo = mGeometries["shapeGeo"].get();
